                ...
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change24h === null || props.change24h === 0 ? "N/A" : props.change24h}
                            valueStyle={props.change24h <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change24h < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change24h === null || props.change24h === 0 ? "" : props.change24h < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change24h === null || props.change24h === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change7d === null || props.change7d === 0 ? "N/A" : props.change7d}
                            valueStyle={props.change7d <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change7d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change7d === null || props.change7d === 0 ? "" : props.change7d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change7d === null || props.change7d === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change14d === null || props.change14d === 0 ? "N/A" : props.change14d}
                            valueStyle={props.change14d <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change14d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change14d === null || props.change14d === 0 ? "" : props.change14d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change14d === null || props.change14d === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change30d === null || props.change30d === 0 ? "N/A" : props.change30d}
                            valueStyle={props.change30d <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change30d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change30d === null || props.change30d === 0 ? "" : props.change30d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change30d === null || props.change30d === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change60d === null || props.change60d === 0 ? "N/A" : props.change60d}
                            valueStyle={props.change60d <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change60d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change60d === null || props.change60d === 0 ? "" : props.change60d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change60d === null || props.change60d === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change200d === null || props.change200d === 0 ? "N/A" : props.change200d}
                            valueStyle={props.change200d <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change200d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change200d === null || props.change200d === 0 ? "" : props.change200d < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change200d === null || props.change200d === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
                    <Card>
                        <Statistic
                            ...
                            value={props.change1y === null || props.change1y === 0 ? "N/A" : props.change1y}
                            valueStyle={props.change1y <= 0 ? { color: '#cf1322' } : { color: '#3f8600' }}
                            prefix={props.change1y < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined /> && props.change1y === null || props.change1y === 0 ? "" : props.change1y < 0 ? <ArrowDownOutlined /> : <ArrowUpOutlined />}
                            precision={2}
                            suffix={props.change1y === null || props.change1y === 0 ? "" : "%"}
                        />
                    </Card>
                </Col>
                <Col span={12}>
